...
// ==========================================
const firstTask = 10 > 30;
console.log("Is 10 groter dan 20?", firstTask);
...
// ==========================================
const secondTask = 10 !== 11;
console.log("Is 10 ongelijk aan 11?", secondTask);

// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================
const task3 = "zoet" ==  "sappig";
console.log("Zijn de woorden 'zoet' en 'sappig' het zelfde?", task3 );
...
// ==========================================
const grade = 9;
const isPassed = grade >= 8;
console.log(isPassed, "Cum laude");
